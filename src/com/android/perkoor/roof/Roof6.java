...
protected World mWorld;
	...
	protected Body bodyroof_6;
	WYSize s;
	public Roof6(World world,Box2D box2d){
	...
	public void set_border (float x){
		...
		bodyroof_6 = mLoader.createBodyByName(mBox2d, "roof_6");
		bodyroof_6.setType(Body.TYPE_KINEMATIC);

		bodyroof_6.setTransform(mBox2d.pixel2Meter(x), mBox2d.pixel2Meter(0f), 0);
		...
		bodyroof_6.setUserData(sprite);
		mBox2d.addChild(sprite);
	}
	
	public void updata_img( ){
		
		Sprite sprite = (Sprite) bodyroof_6.getUserData();
			sprite.setPosition(mBox2d.meter2Pixel(bodyroof_6.getPosition().x),
					mBox2d.meter2Pixel(bodyroof_6.getPosition().y));
